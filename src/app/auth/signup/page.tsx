      ...
      <div className="flex items-center justify-center h-screen">
        <div className="flex   justify-center align-center ">
          <div className="flex flex-col items-center justify-center w-sm p-6 rounded-lg bg-neutral-950  border-zinc-100 border-2 shadow-md">
            ...
            <Link href={"/auth/login"} className= "text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full">
              Login
            </Link>
          </div>
        </div>
